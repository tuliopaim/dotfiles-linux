...
description: >
  Entity Framework Core patterns and best practices for .NET projects. Covers
  NoTracking defaults, migration management, Aspire integration, execution
  strategy for retries, bulk operations, query splitting, and common pitfalls.
---
